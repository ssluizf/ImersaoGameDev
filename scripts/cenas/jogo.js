class Jogo {
    ...
    setup() {
        ...
        const inimigoBoss = new Inimigo(matrizInimigo, imagemInimigo, width, 30, 104, 104, 104, 104, 10);
        const inimigoVoadorBoss = new Inimigo(matrizInimigoVoador, imagemInimigoVoador, width, 200, 200, 150, 200, 150, 10);

        inimigos.push(inimigo)
        inimigos.push(inimigoGrande)
        inimigos.push(inimigoVoador)
        inimigos.push(inimigoBoss)
        inimigos.push(inimigoVoadorBoss)
    }
